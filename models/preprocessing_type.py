...
def main():
    ...
    # Save
    train_path = os.path.join(OUTPUT_DIR, "type_train.csv")
    val_path = os.path.join(OUTPUT_DIR, "type_val.csv")
    full_path = os.path.join(OUTPUT_DIR, "type_preprocessed_full.csv")
